/**
 * Class TestCandidate3 tests class Candidate and prints the output to the console!
 * 
 * @author C. Thurston
 * @version 5/17/2014
 */
public class TestCandidate3
{
    ...
    public static void main(String[] args)
    {
        ...
        changeName(candidates, "Kathleen Turner", "John Kennedy");
        changeVote(candidates, 2500, 8000);
